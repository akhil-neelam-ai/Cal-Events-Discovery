          ...
          <div className="mt-5 flex flex-wrap items-center justify-center gap-2.5">
            {DESKTOP_HERO_PRESETS.map((preset) => (
              <button
                ...
                className="rounded-full border border-[rgba(253,181,21,0.45)] bg-white/[0.04] px-5 py-2.5 text-sm font-medium text-white/90 transition hover:border-[#FDB515] hover:bg-[rgba(253,181,21,0.14)] hover:text-white focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-berkeley-gold focus-visible:ring-offset-2"
              >
                {preset.label}
              </button>
            ))}
