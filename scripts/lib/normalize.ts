...
const ORGANIZER_MAP: Array<[RegExp, FrontendCategory]> = [
  [
    /\b(eecs|electrical engineering|computer science|simons institute|berkeley ai risk|berkeley risk and security|brsl|data science|statistics|bioengineering|computational|informatics)\b/i,
    "Science & Tech",
  ],
  [
